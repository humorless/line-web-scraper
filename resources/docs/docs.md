...
The `home-routes` handler in the `line-web-scraper.routes.home` namespace
...
The `home-page` function will in turn call the `line-web-scraper.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `line-web-scraper.handler` namespace:
...
Request middleware functions are located under the `line-web-scraper.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `line-web-scraper.dev-middleware` namespace found in
